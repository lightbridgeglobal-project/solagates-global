        ...
        <div className="w-[90%] md:w-[85%] 2xl:w-[75%] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="bg-primary p-8 rounded-3xl text-white">
              ...
              <a
                href="https://wa.me/2348075155862"
                target="_blank"
                rel="noreferrer"
              ...
              <AnimatePresence mode="wait">
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <h3 className="font-display font-bold text-3xl text-primary mb-4">Request Received</h3>
                    <p className="font-sans text-grey-600 max-w-md mx-auto">
                      Our engineering desk has received your inquiry. A technical lead will be assigned to your case and contact you within 24 hours.
                    </p>
                  </motion.div>
                ) : (
                  <motion.form
