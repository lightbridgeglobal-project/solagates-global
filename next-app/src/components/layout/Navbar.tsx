      ...
      >
        <div className="flex justify-between items-center mx-auto w-[90%] 2xl:w-[75%] h-full text-white">
          <Link href="/" className="flex items-center gap-3 relative z-[60]">
            <img src="/logo.png" alt="Solagates Logo" className="h-10 object-contain invert" />
          ...
          {/* Desktop Navigation */}
          <ul className="hidden xl:flex gap-x-8 list-none font-sans font-medium text-[14px] uppercase tracking-[0.08em]">
            {NAV_LINKS.map((link) => (
              <li key={link.name}>
          ...
          <div className="hidden xl:flex items-center gap-4">
            <Link
              href="/calculator"
              className="bg-accent text-primary font-display text-[11px] tracking-widest uppercase font-bold px-6 py-3 rounded-full hover:bg-white transition-all shadow-md"
            >
          ...
          >
            ...
            >
              <Link
                href="/calculator"
                onClick={() => setIsOpen(false)}
                className="block bg-accent text-primary text-center font-display text-[14px] tracking-widest uppercase font-bold px-6 py-4 rounded-full shadow-md min-h-[56px] flex items-center justify-center"
              >
                Get Free Consultation
              </Link>
            </motion.div>
