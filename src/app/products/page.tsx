...
const PRODUCTS = [
  ...
  },
  {
    ...
    category: "Solar Panels",
    image: "/residential-rooftop-solar-africa.jpeg",
  ...
  },
  {
    ...
    image: "/lithium-battery-bank.jpeg",
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto pt-6 border-t border-grey-100 flex gap-4">
                      <a
                        href={`https://wa.me/2348075155862?text=${encodeURIComponent(`*Product Inquiry*\n\n*Product:* ${product.name}\n*Category:* ${product.category}\n*Description:* ${product.desc}\n*Specifications:*\n${product.specs.map(s => `- ${s}`).join('\n')}\n\nHello Solagates, I am interested in purchasing this product. Please provide pricing and availability.`)}`}
                        target="_blank"
                        rel="noreferrer"
