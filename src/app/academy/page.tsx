          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TIERS.map((tier, i) => (
              ...
              >
                ...
                <a
                  href={`https://wa.me/2348075155862?text=${encodeURIComponent(`*Academy Enrollment Request*\n\n*Program:* ${tier.title}\n*Level:* ${tier.subtitle}\n*Fee:* ${tier.fee}\n\nHello Solagates, I am interested in enrolling for this program and would like to get started.`)}`}
                  target="_blank"
                  rel="noreferrer"
